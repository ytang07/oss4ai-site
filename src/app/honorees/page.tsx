  ...
  return <div className="site-shell flex min-h-screen flex-col">
    ...
    <main className="flex-grow">
      <section className="mx-auto max-w-7xl px-5 pb-16 pt-16 sm:px-8 sm:pt-24 lg:px-10">
        ...
        <p className="mt-8 max-w-2xl text-lg leading-8 text-[var(--muted)]">A living record of the people whose work, ideas, and generosity are shaping AI innovation and technology.</p>
      </section>
