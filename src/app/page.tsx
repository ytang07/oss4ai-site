    ...
    <div className="font-sans antialiased flex flex-col min-h-screen">
      ...
      <PartnerLogos />
        ...
        <section className="py-16 px-4 md:px-8 bg-[var(--background)] text-center">
          ...
          <a
            href="/calendar"
            className="bg-[var(--secondary-color)] hover:bg-[var(--secondary-color)] text-[var(--foreground)] font-bold py-3 px-6 rounded-lg text-lg transition duration-300 ease-in-out"
          >
            Go to Calendar
          </a>
        </section>
