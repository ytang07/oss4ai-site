...
// 	const company = companyData.find((s) => s.slug === params?.slug);
// 	return { props: { company } };
// };

// const ParticipantPage = ({ participant }: { participant: any }) => {
...
// 					</div>
// 				</article>
// 				<SidebarGallery currentSpeaker={speaker.name} speakers={companyData} advisors={advisorsData2024} />
// 			</div>
// 		</div>
// 	);
// };
