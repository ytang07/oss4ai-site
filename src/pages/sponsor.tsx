    ...
    return (
        <div className='relative'>
            ...
            <NextSeo
                ...
                canonical='https://www.oss4.ai/sponsor'
                openGraph={{
                    url: 'https://www.oss4.ai/sponsor',
                    title: 'Sponsorship Packages | Turing Minds Speaker Series',
                    description: 'Explore sponsorship opportunities for the Turing Minds Speaker Series. Support groundbreaking research and the future of technology.',
            ...
            <div className='relative z-10'>
                <header className='min-h-screen flex flex-col relative'>
                    <div className='fixed top-0 left-0 right-0 z-50 bg-white bg-opacity-90 backdrop-filter backdrop-blur-lg md:relative md:bg-transparent md:backdrop-filter-none'>
                        <div className='text-center py-4 md:mb-16 md:pt-64'>
                            <Link href="/" className="absolute top-4 left-4 text-[#420069] hover:text-[#d4af37]">
                                ← Back to Homepage
                            </Link>
                            <motion.h1
                    ...
                    >
                        <h2 className='text-2xl md:text-3xl font-semibold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-[#420069] to-[#d4af37]'>Sponsorships and Visibility</h2>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                            {sponsorTiers.map((tier, index) => (
                                <div key={index} className='bg-white rounded-lg shadow-lg p-6'>
                                    <h3 className='text-2xl font-semibold mb-4 text-[#420069]'>{tier.name}</h3>
                ...
                <section className='my-24 px-8'>
                    <div className='max-w-4xl mx-auto bg-white rounded-lg p-8'>
                        <h2 className='text-3xl font-semibold mb-6 text-[#420069]'>Become a Sponsor</h2>
                        ...
                        <Link href='/#contact' onClick={handleContactClick} className='outline-[#420069] outline px-4 py-2 italic hover:bg-[#420069] hover:text-white transition-colors duration-300 inline-block mt-4'>
                            Contact Us
                        </Link>
                        {contactClicked && <p className='text-[#420069] mt-4 ibm-plex-mono'>Thank you for your interest!</p>}
                    </div>
                </section>
